...
__author__ = "Ahnaf Ahmed"
__version__ = "1.0.1"
__email__ = "ahnafahmedjarif@gmail.com"
...
def get_category_list(content):
    """takes content of home page and returns a list of categories and their url"""

    return category_pat.findall(content)


def get_book_list(content):
    """takes content of a book list page and returns a list of books (name and url)"""
...
def get_page_content(url):
    ...
    """takes an url and returns the content of the page"""
    try:
    ...
    logging.error(f"Can not get content from URL: {url}")
    return ""
...
if __name__ == "__main__":
    ...
    logging.basicConfig(
        format='%(asctime)s %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p', filename="bookstore_crawler.log", level=logging.DEBUG)
